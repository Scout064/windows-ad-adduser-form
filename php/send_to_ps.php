...
$powershell2 = "New-ADUser -Name:".$name." -GivenName:".$given_name." -Surname:".$surname." -SamAccountName:".$username." -UserPrincipalName:".$email." -Path:".escapeshellarg('OU=$usergroup,OU=users,OU=anotherou,DC=ad,DC=fqdn,DC=tld')." -AccountPassword:".'$secureString'." -Enabled:".'$true'."\n";
